...
export const registerController = async (req, res) => {
  try {
    const { name, email, password, phone, address, answer, userType } = req.body;
    //validations
    if (!name || !email || !password || !phone || !address || !answer || !userType) {
...
export const getFarmerController = async (req, res) => {
  try {
    ...
    res.status(500).send({
      success: false,
      message: "Error in fetching farmer details",
      error,
    });
  }
};
